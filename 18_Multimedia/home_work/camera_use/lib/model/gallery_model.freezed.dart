...
abstract class $GalleryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<String> images, int count});
}
...
class _$GalleryModelImpl implements _GalleryModel {
  const _$GalleryModelImpl(
      {required final List<String> images, required this.count})
      : _images = images;
  ...
  @override
  String toString() {
    return 'GalleryModel(images: $images, count: $count)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_images), count);
...
abstract class _GalleryModel implements GalleryModel {
  const factory _GalleryModel(
      ...
      required final int count}) = _$GalleryModelImpl;
