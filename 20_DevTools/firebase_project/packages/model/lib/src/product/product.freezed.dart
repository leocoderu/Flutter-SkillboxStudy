...
class _$_Product implements _Product {
  const _$_Product(
      ...
      @JsonKey(name: _kPlace) this.place,
      @JsonKey(name: _kName) this.name,
      @JsonKey(name: _kPrice) this.price,
      @JsonKey(name: _kCurrency) this.currency,
      @JsonKey(name: _kQuantity) this.quantity,
      @JsonKey(name: _kUnit) this.unit,
      @JsonKey(name: _kBought) this.bought,
      @JsonKey(name: _kHide) this.hide);
  ...
  @override
  String toString() {
    return 'Product(id: $id, place: $place, name: $name, price: $price, currency: $currency, quantity: $quantity, unit: $unit, bought: $bought, hide: $hide)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, place, name, price, currency,
      quantity, unit, bought, hide);
